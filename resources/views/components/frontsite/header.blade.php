    ...
    <div class="hidden lg:ml-10 lg:flex lg:items-center border-l pl-4 pt-2" >
      <div x-data="{ profileDekstopOpen: false }" class="ml-3 relative">
          <div>
              ...
              <!-- focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 -->
                  ...
                  <div class="text-right mr-5">
                      ...
                      <div class="text-sm ml-5 text-[#AFAEC3]">Attendance</div>
                  </div>
                  <img
                      class="h-12 w-12 rounded-full ring-1 ring-offset-4 ring-[#0D63F3]"
                      src="{{ asset('/assets/frontsite/images/profile3.jpg') }}"
                      alt="User Profile"
                      />
              </button>
          </div>
          <div
                            ...
                            @click.outside="profileDekstopOpen = true"
                            ...
                            tabindex="-1"
             >
                  <a href="{{ route('index') }}" class="block px-4 py-2 text-sm text-white
                  hover:bg-white/20" 
                  role="menuitem" 
                  tabindex="-1" 
                  id="user-menu-item-0">
                  ...
                  <a
                    href="{{ route('logout') }}"onclick="event.preventDefault(); document.getElementById('logout-form').
                    submit();"

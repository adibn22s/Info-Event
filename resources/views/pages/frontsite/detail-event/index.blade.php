...
<div>
    ...
    <div class="mx-48 my-16 flex">
        <img src="{{ url(Storage::url($event->poster)) }}" alt="Event" class="object-cover h-2/5 w-2/5">
        <div class="ml-40 my-16">
        <span class="border-2 rounded-3xl text-white flex px-2 py-3 mb-4"><img src="{{ asset('assets/frontsite/images/2.png') }}" alt="Jam" class="h-10 w-10 my-4"><span class="ml-3 mr-24"><span class="underline">Date and Time</span><br>{{ $event->date_is_held}}<br>{{ $event->time}}<br></span></span>
        ...
        <span class="border-2 rounded-3xl text-white flex px-2 py-3 mb-4"><img src="{{ asset('assets/frontsite/images/1.png') }}" alt="Jam" class="h-10 w-10 my-4"><span class="ml-3"><span class="underline">Join The Event</span><br>{{ $event->invite_group_link}}</span></span>
        </div>
    </div>
